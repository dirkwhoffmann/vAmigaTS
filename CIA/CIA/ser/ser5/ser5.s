...
MAIN:	
	...
	; Configure CIAs
	move.b  #$00,CIAB_DDRA      ; Configure PA pins as inputs
	move.b  #$40,CIAB_CRA       ; SP pin is output
	move.b  #$00,CIAB_CRA       ; SP pin is input
	move.b  #$AA,CIAB_SDR 


	; Initialize variables
	moveq   #0,d0               ; Value written to CIAB::PRB
	move.b  d0,CIAB_PRB 
...
irq3:
	...
	move.b  CIAB_ICR,d1         ; Clear by reading

	move.b  #$01,CIAB_PRA       ; Generate CNT pulses
	move.b  #$03,CIAB_PRA
	...
	move.b  CIAB_ICR,d1         ; Upper color bars
	move.b  CIAB_SDR,d0         ; Lower color bars
