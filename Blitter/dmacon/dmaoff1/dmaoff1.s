...
.bitplaneloop:
	...
	move.w	#$8040,INTENA(a1)   ; BLITTER (3)
...
prepareblit:	
	move.w  #(15<<8|BLIT_MINTERM),BLTCON0(a1)
	move.w  #0,BLTCON1(a1) 
	move.l  #$ffffffff,BLTAFWM(a1)   	; No masking
	move.w  #0,BLTAMOD(a1)              ; Modulos
	move.w  #0,BLTBMOD(a1)
	move.w  #0,BLTCMOD(a1)
	move.w  #0,BLTDMOD(a1)
	move.l  #bitplanes,BLTAPTH(a1)	    ; Pointers 
	move.l  #bitplanes,BLTBPTH(a1)	    
	move.l  #bitplanes,BLTCPTH(a1)	    
	move.l  #bitplanes,BLTDPTH(a1)	    
	move.w  #$0,BLTADAT(a1)             ; Registers
	move.w  #$0,BLTBDAT(a1)
	move.w  #$0,BLTCDAT(a1)
	move.w  #$0,BLTDDAT(a1)
	rts
