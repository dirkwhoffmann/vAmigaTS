...
irq4:
	...
	move.w  #(120)<<6|(60),BLTSIZE(a1)
	move.w  #BLIT1COLOR,COLOR00(a1)

	moveq   #20,d6 
.l1:dbra    d6,.l1

	move.w  #$0040,DMACON(a1)           ; Blitter DMA off
	move.w  #$000,COLOR00(a1)

	moveq   #20,d6 
.l2:dbra    d6,.l2

	move.w  DMACONR(a1),d5              ; Record DMACONR

	moveq   #20,d6 
.l3:dbra    d6,.l3

	move.w  #$8040,DMACON(a1)           ; Blitter DMA on
	move.w  #BLIT1COLOR,COLOR00(a1)
	rte
...
bit0:
	...
	dc.w    $A101, $7FFE      ; WAIT until Blitter terminates
	dc.w	COLOR00, $000
