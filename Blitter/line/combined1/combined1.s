...
runtest:
	...
	; ... followed by a copy blit (without modifying BLTCON0)
	bsr     blitWait
	move.l  #bitplanes,BLTAPTH(a1)
	move.l  #bitplanes+1*40,BLTCPTH(a1)
	move.l  #bitplanes+2*40,BLTDPTH(a1)
	move.w  #$00,BLTCON1(a1)                  ; Line mode off
	move.w  #$4C,BLTSIZE(a1)
	rts
