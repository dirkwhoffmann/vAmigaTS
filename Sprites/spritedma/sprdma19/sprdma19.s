...
copper:
	...
	dc.w    $4001,$FFFE  ; WAIT
	dc.w    SPR0CTL,$4000 ; Enables DMA manually

	dc.w    $5801,$FFFE  ; WAIT 
	dc.w    SPR2CTL,$5800 ; Enables DMA manually

	dc.w    $5FDF,$FFFE  ; WAIT 
	dc.w    SPR6CTL,$5F00 ; Doesn't enable DMA, because of early vpos incrementation
	...
	dc.w    $9807,$FFFE  ; WAIT
	dc.w    SPR2CTL,$9800 ; Enables DMA manually
	...
	dc.w    $A1DF,$FFFE  ; WAIT
	dc.w    SPR4CTL,$A200 ; Enables DMA manually
...
SPRITE0:
	        ...
	        DC.W    $03C0,$0000 ; 15
			;
			DC.W    $0044,$0000 ; Does never match
			;
