...
irq1:
	...
	move.l  a7,a6
	lea     COLOR00(a1),a7    ; Redirect stack pointer to color registers
	link    a4,#0
...
irq5:
	move.w  #$3FFF,INTREQ(a1) ; Acknowledge
	move.l  a7,a6
	lea     COLOR06(a1),a7    ; Redirect stack pointer to color registers
	link    a4,#0
	move.w  #$000,COLOR00(a1)
	move.l  a6,a7             ; Restore stack pointer
	rte
...
irq6:
	move.w  #$3FFF,INTREQ(a1) ; Acknowledge
	move.l  a7,a6
	lea     COLOR08(a1),a7    ; Redirect stack pointer to color registers
	link    a4,#0
	move.w  #$000,COLOR00(a1)
	move.l  a6,a7             ; Restore stack pointer
	rte
