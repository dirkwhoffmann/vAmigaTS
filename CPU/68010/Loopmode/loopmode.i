...
.bitplaneloop:
	...
	move.w	SR,d0			 	; Trigger privilege exception in 68010 mode (will change color)
...
priv:
	move.w	#$F44,d5			; Color used in 68010 mode
	jmp 	mainloop
...
.loop 
	move.w  d3,COLOR00(a1)
	move.w  (a3),d2     
	move.w  d6,COLOR00(a1)
	and     #$FF00,d2
	cmp.w   #$3000,d2
	bne     .loop
	and     #1,VPOSR(a1)
