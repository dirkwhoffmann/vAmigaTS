...
MAIN:
	...
	lea	irq2(pc),a3
 	move.l	a3,vectable1+LVL1_INT_VECTOR+2
	lea	irq3(pc),a3
 	move.l	a3,vectable2+LVL1_INT_VECTOR+2
	lea	irq4(pc),a3
 	move.l	a3,vectable3+LVL1_INT_VECTOR+2
	lea	irq5(pc),a3
 	move.l	a3,vectable4+LVL1_INT_VECTOR+2
	lea	irq6(pc),a3
 	move.l	a3,vectable5+LVL1_INT_VECTOR+2
