...
trap0:
    ...
    ; 17+18: NaN (sign bit = 0)
    fmove.x #$7FFF00000000000000000001,FP0
    DUMP 

    ; 19+20: NaN (sign bit = 1)
    fmove.x #$FFFF00000000000000000001,FP0
    DUMP 

    ; 21+22: NaN (sign bit = 0)
    fmove.x #$7FFF00001000000000000000,FP0
    DUMP 

    ; 23+24: NaN (sign bit = 1)
    fmove.x #$FFFF00001000000000000000,FP0
    DUMP 
...
expected:
    ...
    dc.b    $00,$00,$00,$01,  $09,$00,$40,$80  ; 20
    dc.b    $7F,$FF,$00,$00,  $50,$00,$00,$00  ; 21
    dc.b    $00,$00,$00,$00,  $01,$00,$40,$80  ; 22
    dc.b    $FF,$FF,$00,$00,  $50,$00,$00,$00  ; 23
    dc.b    $00,$00,$00,$00,  $09,$00,$40,$80  ; 24
