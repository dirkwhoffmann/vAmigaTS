...
expected:
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 1
    dc.b    $00,$00,$00,$00,  $08,$00,$02,$08  ; 2
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 3
    dc.b    $00,$00,$00,$10,  $08,$00,$02,$08  ; 4
    dc.b    $FF,$FC,$00,$00,  $00,$00,$00,$00  ; 5
    dc.b    $00,$00,$00,$20,  $08,$00,$02,$08  ; 6
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 7
    dc.b    $00,$00,$00,$30,  $08,$00,$02,$08  ; 8
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 9
    dc.b    $00,$00,$00,$40,  $08,$00,$02,$08  ; 10
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 11
    dc.b    $00,$00,$00,$50,  $08,$00,$02,$08  ; 12
    dc.b    $FF,$FC,$00,$00,  $00,$00,$00,$00  ; 13
    dc.b    $00,$00,$00,$60,  $08,$00,$02,$08  ; 14
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 15
    dc.b    $00,$00,$00,$70,  $08,$00,$02,$08  ; 16
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 17
    dc.b    $00,$00,$00,$80,  $08,$00,$02,$08  ; 18
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 19
    dc.b    $00,$00,$00,$90,  $08,$00,$02,$08  ; 20
    dc.b    $FF,$FC,$00,$00,  $00,$00,$00,$00  ; 21
    dc.b    $00,$00,$00,$A0,  $08,$00,$02,$08  ; 22
    dc.b    $FF,$FD,$00,$00,  $00,$00,$00,$00  ; 23
