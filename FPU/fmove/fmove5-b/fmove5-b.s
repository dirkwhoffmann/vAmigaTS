...
expected:
    dc.b    $C0,$05,$00,$00,  $F8,$00,$00,$00  ; 1
    dc.b    $00,$00,$00,$00,  $08,$00,$00,$00  ; 2
    dc.b    $C0,$05,$00,$00,  $F0,$00,$00,$00  ; 3
    dc.b    $00,$00,$00,$00,  $08,$00,$00,$00  ; 4
    dc.b    $40,$02,$00,$00,  $C0,$00,$00,$00  ; 5
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 6
    dc.b    $40,$03,$00,$00,  $80,$00,$00,$00  ; 7
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 8
    dc.b    $40,$03,$00,$00,  $A0,$00,$00,$00  ; 9
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 10
    dc.b    $40,$03,$00,$00,  $C0,$00,$00,$00  ; 11
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 12
    dc.b    $40,$03,$00,$00,  $E0,$00,$00,$00  ; 13
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 14
    dc.b    $40,$04,$00,$00,  $80,$00,$00,$00  ; 15
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 16
    dc.b    $C0,$05,$00,$00,  $F8,$00,$00,$00  ; 17
    dc.b    $00,$00,$00,$00,  $08,$00,$00,$00  ; 18
    dc.b    $C0,$05,$00,$00,  $F0,$00,$00,$00  ; 19
    dc.b    $00,$00,$00,$00,  $08,$00,$00,$00  ; 20
    dc.b    $40,$02,$00,$00,  $C0,$00,$00,$00  ; 21
    dc.b    $00,$00,$00,$00,  $00,$00,$00,$00  ; 22
    dc.b    $40,$03,$00,$00,  $80,$00,$00,$00  ; 23
