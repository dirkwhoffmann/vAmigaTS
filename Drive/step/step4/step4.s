...
STEPDELAY           equ 2         ; 2148 is original value
...
;
	...
	moveq   #10,d1
	jsr     moveHead           ; Move to track 10

	moveq   #10,d1
	jsr     moveOutwardsQuick  ; Move inward quick
...
moveOutwardsQuick:          ; Number of steps in d1
    bset.b  #1,CIAB_PRB     ; Move outwards
	subq    #1,d1
.loop2:          
...
;
; Emulate a between two steps that is shorter than the specs require
; In UAE, a value of 15 is too less to move the head every time
;
;	moveq   #15,d2
;.loop3: 
;    dbra    d2,.loop3
