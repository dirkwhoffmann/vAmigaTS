...
; fmode11k -- same misaligned-plane set as fmode11a/fmode11f (planes
; 1,2,3,4,5,6,7,8), but with MISALIGN_OFFSET set to 6 instead of 4 or 2. 6 is the
...
; matters, fmode11k should reproduce fmode11f's picture. If it instead
; matches fmode11a (offset 4) or differs from both, the offset's sign --
