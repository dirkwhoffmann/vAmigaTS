...
copper:
	...
	; Modify BLTCON0 while the Blitter is still running
	dc.w	$3A51,$FFFE  ; WAIT 
	dc.w    BLTCON0, (3<<8|BLIT_LF_MINTERM|BLIT_A_SOURCE_SHIFT<<BLIT_ASHIFTSHIFT)

	dc.w    $3251,$7FFE  ; WAIT until Blitter is finished (BFD = 0)
	dc.w    COLOR00, $0F0
	dc.w    COLOR00, $000
