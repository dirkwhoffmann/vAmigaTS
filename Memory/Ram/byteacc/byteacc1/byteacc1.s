...
MAIN:	
	...
	move.w	#$8080,INTENA(a1)   ; Aud0
	move.w	#$8020,INTENA(a1)   ; VERTB
...
irq3:
	...
	moveq   #0,d0
	moveq   #0,d1
	move.w  #$7FFF,INTENA(a1)   ; Abuse INTENA and INTENAR do to the byte access test	
	move.w  #$8FF0,INTENA(a1)	
	move.b  INTENAR(a1),d1      ; Upper color bars
	move.b  (INTENAR+1)(a1),d0  ; Lower color bars
	move.w  #$7FFF,INTENA(a1)	; Clear up the mess
	move.w	#$C0A4,INTENA(a1)   ; Soft
...
bit0:
	...
	dc.w    $D001,$FFFE
	dc.w    INTREQ,$8004 ; IRQ 1

	dc.w    $E001,$FFFE
	dc.w    INTREQ,$8080 ; IRQ 4
